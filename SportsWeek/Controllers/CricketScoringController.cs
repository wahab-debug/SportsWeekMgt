            ...
            try
            {
                ...
                var query = from di in deliveryWithImages
                            ...
                            from strikerStudent in strikerStudentJoin.DefaultIfEmpty()
                                ...
                                // Non-striker details
                            join nonStrikerPlayer in db.Players on di.Delivery.non_striker_id equals nonStrikerPlayer.id into nonStrikerJoin
                            ...
                            from nonStrikerStudent in nonStrikerStudentJoin.DefaultIfEmpty()
                                ...
                                // Bowler details
                            join bowlerPlayer in db.Players on di.Delivery.bowler_id equals bowlerPlayer.id into bowlerJoin
                            ...
                            from bowlerStudent in bowlerStudentJoin.DefaultIfEmpty()
                                ...
                                // Dismissed player details (if applicable)
                            join dismissedPlayer in db.Players on di.Delivery.dismissed_player_id equals dismissedPlayer.id into dismissedJoin
                            ...
                            from dismissedStudent in dismissedStudentJoin.DefaultIfEmpty()
                                ...
                                // Fielder details (if applicable)
                            join fielderPlayer in db.Players on di.Delivery.fielder_id equals fielderPlayer.id into fielderJoin
                            ...
                            select new
                            {
                                ...
                                imagepath = di.Image.image_path,
                                deliveriesid = di.Delivery.id,
                                score = di.Delivery.runs_scored.ToString(),
                                wicket = di.Delivery.wicket_type,

                                // Player Details
                                StrikerId = di.Delivery.striker_id,
                                StrikerName = strikerStudent != null ? strikerStudent.name : "Unknown",
                                NonStrikerId = di.Delivery.non_striker_id,
                                NonStrikerName = nonStrikerStudent != null ? nonStrikerStudent.name : "Unknown",
                                BowlerId = di.Delivery.bowler_id,
                                BowlerName = bowlerStudent != null ? bowlerStudent.name : "Unknown",
                                DismissedPlayerId = di.Delivery.dismissed_player_id,
                                DismissedPlayerName = dismissedStudent != null ? dismissedStudent.name : "Unknown",
                                FielderId = di.Delivery.fielder_id,
...
/*                var Deliveryimages = query.ToList();
*/
                var playerDetails =
